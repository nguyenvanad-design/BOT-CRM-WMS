...
CONSUMABLE_SETS: List[dict] = [
    {
        ...
        "items": [
            ...
            {"part_id": "033203", "priority_rank": 3, "is_mandatory": True,  "default_quantity": 2,  "part_role": "Nozzle",     "note": "Chụp khí HR-350 16mm 68L"},
            {"part_id": "004002", "priority_rank": 4, "is_mandatory": True,  "default_quantity": 1,  "part_role": "Insulator",  "note": "Cách điện N S (350A)"},
            {"part_id": "003002", "priority_rank": 5, "is_mandatory": True,  "default_quantity": 1,  "part_role": "Orifice",    "note": "Sứ chia khí N S (350A)"},
        ]
    },
    {
        "set_id": "N350A_09wire",
    ...
    },
    {
        ...
        "items": [
            ...
            {"part_id": "023013", "priority_rank": 2, "is_mandatory": True,  "default_quantity": 2,  "part_role": "Nozzle",    "note": "Chụp khí D No.10 16mm 70L"},
            {"part_id": "023014", "priority_rank": 3, "is_mandatory": True,  "default_quantity": 1,  "part_role": "Orifice",   "note": "Sứ chia khí D S (350A)"},
            {"part_id": "023015", "priority_rank": 4, "is_mandatory": True,  "default_quantity": 1,  "part_role": "Insulator", "note": "Cách điện D S (350A)"},
        ]
    },
    {
        ...
        "items": [
            {"part_id": "023020", "priority_rank": 1, "is_mandatory": True,  "default_quantity": 10, "part_role": "Tip"},
            {"part_id": "023021", "priority_rank": 2, "is_mandatory": True,  "default_quantity": 2,  "part_role": "Nozzle"},
        ]
    },
    {
    ...
    },
    {
        ...
        "items": [
            ...
            {"part_id": "002003", "priority_rank": 2, "is_mandatory": True,  "default_quantity": 10, "part_role": "Tip"},
            {"part_id": "001001", "priority_rank": 3, "is_mandatory": True,  "default_quantity": 2,  "part_role": "Nozzle"},
            {"part_id": "004001", "priority_rank": 4, "is_mandatory": True,  "default_quantity": 1,  "part_role": "Insulator"},
            {"part_id": "003001", "priority_rank": 5, "is_mandatory": True,  "default_quantity": 1,  "part_role": "Orifice"},
        ]
    },
    {
        ...
        "items": [
            {"part_id": "002001", "priority_rank": 1, "is_mandatory": True,  "default_quantity": 10, "part_role": "Tip",    "note": "Béc hàn N 0.9mm (CSL dùng chuẩn N)"},
            {"part_id": "038040", "priority_rank": 2, "is_mandatory": True,  "default_quantity": 2,  "part_role": "Nozzle", "note": "Chụp khí 200A ∅13mm 75L"},
            {"part_id": "038041", "priority_rank": 3, "is_mandatory": False, "default_quantity": 1,  "part_role": "Nozzle", "note": "Chụp khí 200A ∅16mm straight (optional)"},
            {"part_id": "004002", "priority_rank": 4, "is_mandatory": True,  "default_quantity": 1,  "part_role": "Insulator"},
            {"part_id": "003002", "priority_rank": 5, "is_mandatory": True,  "default_quantity": 1,  "part_role": "Orifice"},
            {"part_id": "036001", "priority_rank": 6, "is_mandatory": True,  "default_quantity": 1,  "part_role": "TipBody"},
        ]
    },
    {
    ...
    },
    {
        ...
        "items": [
            ...
            {"part_id": "034115", "priority_rank": 2, "is_mandatory": True, "default_quantity": 2, "part_role": "Nozzle"},
            {"part_id": "034120", "priority_rank": 3, "is_mandatory": True, "default_quantity": 1, "part_role": "Orifice"},
            {"part_id": "061445", "priority_rank": 4, "is_mandatory": True, "default_quantity": 1, "part_role": "WXCenterCeramic"},
            {"part_id": "002003", "priority_rank": 5, "is_mandatory": True, "default_quantity": 10,"part_role": "Tip"},
        ]
    },
    {
        ...
        "items": [
            ...
            {"part_id": "034120", "priority_rank": 3, "is_mandatory": True, "default_quantity": 1, "part_role": "Orifice"},
            {"part_id": "061445", "priority_rank": 4, "is_mandatory": True, "default_quantity": 1, "part_role": "WXCenterCeramic"},
            {"part_id": "061447", "priority_rank": 5, "is_mandatory": True, "default_quantity": 1, "part_role": "WXNozzleAdapter"},
            {"part_id": "002003", "priority_rank": 6, "is_mandatory": True, "default_quantity": 10,"part_role": "Tip"},
        ]
    },
    {
        ...
        "items": [
            {"part_id": "025003", "priority_rank": 1, "is_mandatory": True, "default_quantity": 10,"part_role": "Tip",    "note": "TCC Tip 1.2mm (M8×1.25)"},
            {"part_id": "025010", "priority_rank": 2, "is_mandatory": True, "default_quantity": 2, "part_role": "Nozzle", "note": "TCC Nozzle"},
            {"part_id": "025011", "priority_rank": 3, "is_mandatory": True, "default_quantity": 1, "part_role": "Orifice"},
            {"part_id": "025012", "priority_rank": 4, "is_mandatory": True, "default_quantity": 1, "part_role": "Insulator"},
            {"part_id": "025013", "priority_rank": 5, "is_mandatory": True, "default_quantity": 1, "part_role": "TipBody","note": "TCC TipBody M8 — bắt buộc dùng riêng"},
            {"part_id": "016051", "priority_rank": 6, "is_mandatory": True, "default_quantity": 1, "part_role": "Liner"},
            {"part_id": "036035", "priority_rank": 7, "is_mandatory": False,"default_quantity": 1, "part_role": "LinerORing"},
        ]
    },
    {
        ...
        "items": [
            ...
            {"part_id": "TIG-10N44",   "priority_rank": 3, "is_mandatory": True, "default_quantity": 1, "part_role": "CeramicNozzle"},
            {"part_id": "TIG-WL15-24", "priority_rank": 4, "is_mandatory": True, "default_quantity": 1, "part_role": "TungstenElectrode", "note": "WL15 2.4mm"},
